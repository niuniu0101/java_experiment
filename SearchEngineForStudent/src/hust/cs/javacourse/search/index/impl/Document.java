...
public class Document extends AbstractDocument {
    ...
    public AbstractTermTuple getTuple(int index){
        return (index < 0 || index >= this.tuples.size()) ? null : this.tuples.get(index);
    }
    /**
     * 返回文档对象包含的三元组的个数
    ...
    public String toString(){
        StringBuffer sb = new StringBuffer("Document id = " + this.docId + ", path = \"" + this.docPath + "\" with terms: ");
        for(AbstractTermTuple tt : this.tuples)
            sb.append("\n\t").append(tt.toString());
        return sb.toString();
    }
}
